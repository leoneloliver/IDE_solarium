...
$('.code_tab3').html('<div class="google-codelab-step-0"><pre><span class="tag">var</span> <span class="atn">createUser</span> = <span class="atv">function()</span>{<br>&nbsp;&nbsp;<span class="tag">var</span> <span class="atn">id</span> = 0;<br>&nbsp;&nbsp;<span class="tag">var</span> <span class="atn">newUser</span> = <span class="atv">function(<span class="tag">name</span>)</span>{<br>&nbsp;&nbsp;&nbsp;&nbsp;<span>id++;</span><br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tag">return</span> {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="atn">id:</span> id,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="atn">name:</span> name<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;}<br>&nbsp;&nbsp;<span class="tag">return</span> <span class="atn">newUser</span>;<br>}<br><span class="tag">var</span> <span class="atn">createNew</span> = <span class="atv">createUser();</span><br><span class="tag">var</span> <span class="atn">leonel</span> = <span class="atv">createNew("<span class="tag">Leonel</span>");</span><br><span class="tag">console.log</span><span class="atv">(<span class="atn">leonel.id</span>+"-"+<span class="atn">leonel.name</span>);</span></pre></div>  ');
},3000)
